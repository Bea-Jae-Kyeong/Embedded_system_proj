...
const unsigned char track1_note_size[] PROGMEM ={
	 4,  6,  2,  4,  8,  4, 12, 12,
	 6,  2,  4,  8,  4, 16,  4,  4,
	 6,  2,  4,  8,  4,  8,  4,  8,
	 4,  6,  2,  4,  8,  4, 20,  4,
...
const unsigned char track3_note_size[] PROGMEM = {
	8, 8, 8, 8, 8, 8, 8, 8,
8, 8, 8, 8, 8, 8, 8, 8,
8, 8, 8, 8, 8, 8, 8, 8,
8, 8, 8, 8, 8, 8, 8, 8,
...
const unsigned char track4_note_key[] PROGMEM = {
...
const unsigned char track4_note_size[] PROGMEM = {
	2, 4, 4, 2, 1, 1, 1, 1, 
1, 1, 4, 6, 1, 2, 1, 4, 
5, 2, 2, 2, 4, 1, 2, 6, 
3, 1, 1, 1, 1, 3, 4, 2, 
